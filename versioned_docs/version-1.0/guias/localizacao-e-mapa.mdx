...
O jeito mais rápido é pelo **painel do aluno**, em **Retirada → Novo ponto**:
clique no mapa para marcar a coordenada (ou arraste o pin) e preencha o
endereço. De lá também dá para ativar, desativar e editar.
...
origem é a loja (marcada em *Loja → Localização da loja*) e o destino é o endereço
...
No painel, em **Loja → Localização da loja**, clique no mapa para marcar o
endereço da loja. Pela API:
